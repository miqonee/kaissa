...
usePageSeo({
  ...
  description:
    'Архив сыгранных партий на платформе Каисса. Просмотр реплеев командных шахмат 2х2 и багхауса, разбор партий, ходы и экспорт в PGN.',
  keywords: [
    'архив партий',
    'база партий',
  ...
  ogDescription:
    'Архив сыгранных партий на платформе Каисса. Просмотр реплеев командных шахмат 2х2 и багхауса, разбор партий и скачивание PGN.',
